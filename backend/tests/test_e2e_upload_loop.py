...
def _mock_supabase(monkeypatch):
    """Make the shared Supabase async_client return plausible responses."""
    ...
    ctx.async_client.get = AsyncMock(return_value=load_response)
    ctx.async_client.post = AsyncMock(return_value=MagicMock(status_code=204))
