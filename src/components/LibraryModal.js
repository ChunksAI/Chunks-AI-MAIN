        ...
        <div class="library-grid">
          ...
          <div class="library-book-card" onclick="selectBook('zumdahl')">
            <div class="library-book-icon">
              <img src="data:," alt="General Chemistry by Zumdahl &amp; Zumdahl — textbook cover" loading="lazy" onerror="this.parentElement.innerHTML='📗'">
            </div>
          ...
          <div class="library-book-card" onclick="selectBook('atkins')">
            <div class="library-book-icon">
              <img src="data:," alt="Physical Chemistry by Atkins &amp; de Paula — textbook cover" loading="lazy" onerror="this.parentElement.innerHTML='📘'">
            </div>
            <div class="lib-book-info">
          ...
          <div class="library-book-card" onclick="selectBook('klein')">
            <div class="library-book-icon">
              <img src="data:," alt="Organic Chemistry by David Klein — textbook cover" loading="lazy" onerror="this.parentElement.innerHTML='📙'">
            </div>
            <div class="lib-book-info">
          ...
          <div class="library-book-card" onclick="selectBook('harris')">
            <div class="library-book-icon">
              <img src="data:," alt="Quantitative Chemical Analysis by Daniel C. Harris — textbook cover" loading="lazy" onerror="this.parentElement.innerHTML='📒'">
            </div>
            <div class="lib-book-info">
        ...
        <div class="library-grid">
          <div class="library-book-card" onclick="selectBook('anaphy2e')">
            <div class="library-book-icon" style="background:rgba(248,113,113,0.06);">
              <img src="data:," alt="Anatomy &amp; Physiology by Patton &amp; Thibodeau — textbook cover" loading="lazy" onerror="this.parentElement.innerHTML='🫁'">
            </div>
            <div class="lib-book-info">
          ...
          <div class="library-book-card" onclick="selectBook('netter')">
            <div class="library-book-icon" style="background:rgba(248,113,113,0.06);">
              <img src="data:," alt="Atlas of Human Anatomy by Frank H. Netter — textbook cover" loading="lazy" onerror="this.parentElement.innerHTML='🫀'">
            </div>
            <div class="lib-book-info">
